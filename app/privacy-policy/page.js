    ...
    <Navbar/>
      <div className="container p-3 mx-auto pt-28">
        ...
        <p className="pb-2">
          ...
          data when you use our Platform, services or otherwise interact with us
          during the course of our relationship.and related information provided
          from time to time. Some of the information that we may collect
          includes but is not limited to personal data / information provided to
          ...
          responsible for the thirdparty business partner’s privacy practices or
        ...
        <p className="pb-2">
          ...
          updates; customise your experience; detect and protect us against
        ...
        <p className="pb-2">
          ...
          or the general public.Security Precautions- To protect your personal
          data from unauthorised access or disclosure, loss or misuse we adopt
        ...
        <p className="pb-2">
          ...
          cannot always be guaranteed as completely secure, and therefore, there
          would always remain certain inherent risks regarding use of the
          Platform. Users are responsible for ensuring the protection of login
          and password records for their account.Data Deletion and Retention-
          ...
          under any applicable law. However, we may retain data related to 2 you
          ...
          anonymised form for analytical and research purposes.Your Rights- You
          may access, rectify, and update your personal data directly through
          the functionalities provided on the Platform. Consent- By visiting our
