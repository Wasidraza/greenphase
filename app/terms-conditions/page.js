    ...
    <>
      ...
      <div className="container p-3 mx-auto pt-28">
        ...
        <p className="pb-2">
          ...
          for access or usage of domain name greenphase.in, including the
        ...
        <p className="pb-2">
          ...
          the use of your registered account on the Platform. Neither we nor any
        ...
        <p className="pb-2">
          ...
          that the Services meet your requirements. The contents of the Platform
          and the Services are proprietary to us and are licensed to us. You
          will not have any authority to claim any intellectual property rights,
          title, or interest in its contents. The contents includes and is not
          limited to the design, layout, look and graphics. You acknowledge that
          ...
          that is unlawful, illegal or 4 forbidden by these Terms, or Indian or
          ...
          websites. On accessing these links, you will be governed by the terms
          of use, privacy policy and such other policies of such third party
          websites. These links are provided for your convenience for provide
          further information. You understand that upon initiating a transaction
          for availing the Services you are entering into a legally binding and
          ...
          the amount paid by You for using the Services giving rise to the cause
        ...
        <p className="pb-4">
          ...
          subject to the exclusive jurisdiction of the courts in Delhi. All
